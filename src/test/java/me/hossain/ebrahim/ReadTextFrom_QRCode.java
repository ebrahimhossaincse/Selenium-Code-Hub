...
public class ReadTextFrom_QRCode {
    ...
    BinaryBitmap bitmap;
    Result result;
    String qrInputText = "Ebrahim Hossain";
    ...
    @Test
    public void read_qr_code() throws MalformedURLException, IOException, NotFoundException, InterruptedException {
